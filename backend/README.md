...
## Project Structure
    ...
    ├── testapiautoconnecto_60869  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnecto_60869`
...
2. Clone this repo and `cd testapiautoconnecto_60869`
